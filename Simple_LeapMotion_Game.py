...
def Enemies(Num):
    global Create_Enemies, Top_Enemy_pos_change, Bottom_Enemy_pos_change, Left_Enemy_pos_change, Right_Enemy_pos_change, Top_Enemy_pos_fix, Bottom_Enemy_pos_fix, Left_Enemy_pos_fix, Right_Enemy_pos_fix
    ...
    if Create_Enemies == True:
        for i in range(Num):
            ...
            Right_Enemy_pos_change.append(Right_Enemy)
